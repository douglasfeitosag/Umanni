...
## Hardening de entrega local 0.3.1 — integrado, publicação em preparo
...
A spec 017 governa a publicação. Seu planejamento foi aceito no HEAD `2701c3f5ab874506a22b1d680a012458788c03cf` depois da correção R-017-001. O PR #24 prepara os registros; durante sua revisão ele é o único item aberto listado no milestone 0.3.1. Tag, Release e fechamento do milestone permanecem pendentes e só podem ocorrer depois da revisão final e integração desse preparo.
...
- O ciclo 0.3.1 está limitado às regressões #18 e #19 já integradas. A publicação formal permanece condicionada ao PR #24 revisado/integrado, à lista completa vazia do milestone, à tag anotada e à Release no mesmo SHA, nessa ordem. Ver [[EXEC-016-DELIVERY-HARDENING]] e [[EXEC-017-RELEASE-0-3-1]].
