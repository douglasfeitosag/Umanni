...
- No tooling Docker, após `bundle exec vite build`, `bundle exec rspec spec/requests/security_spec.rb` passou no `umanni_test`; a comparação HTML normaliza somente o nonce CSP variável por requisição.
