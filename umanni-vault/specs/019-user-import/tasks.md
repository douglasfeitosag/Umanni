...
- [ ] **E003 — RED preflight** Cobrir US1/US2 para CSV/XLSX, autorização, formato, assinatura, encoding, cabeçalhos, planilhas, bytes/linhas e entradas maliciosas.
- [ ] **E004 — GREEN preflight/lote** Implementar readers, preflight, migrations/modelos/constraints, attachment e create sem processamento síncrono de usuários.
- [ ] **E005 — RED processamento** Cobrir US3/US4: linhas mistas, papel default, duplicatas internas/externas/concorrentes, repetição e falhas entre blocos.
- [ ] **E006 — GREEN processamento** Implementar job/processador/resultados/contadores em blocos, lock por lote, retry limitado e estados terminais.
- [ ] **E007 — senha inicial** Cobrir e implementar US3.3 somente para conta sem credencial, preservando mensagem neutra e D-027.
- [ ] **E008 — RED/GREEN Cable** Cobrir US5, autorizar stream, emitir invalidação após commit, coalescer reload e revogar conexão.
- [ ] **E009 — interface** Implementar histórico, upload, detalhe, progresso e relatório paginado com acessibilidade/responsividade.
- [ ] **E010 — worker/Compose** Adicionar processo worker separado em dev/delivery, arquivos runtime no Dockerfile e gate US6 com restart/cleanup.
