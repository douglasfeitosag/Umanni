...
- **FR-004**: `branding/LICENSES/UMANNI-NOTICE.md` DEVE ser o aviso canônico de uso avaliativo, caráter não oficial, ausência de licença expressa e proibição de reutilização. `branding/README.md`, `BRAND-PLAYBOOK.md`, `PROVENANCE.md`, `VALIDATION.md` e `EXEC-001-BRANDING.md` DEVEM referenciá-lo; cada prancha/composição DEVE exibir aviso resumido e referência ao arquivo canônico sem modificar os assets oficiais preservados.
