...
6. **Licenças e aviso**: confirmar Montserrat, Roboto, Heroicons e o aviso canônico Umanni; verificar referência em README, playbook, especificação de componentes, procedência, validação, manifesto de ícones e EXEC, além do aviso resumido em cada prancha, sem modificar assets oficiais. Não declarar licença da marca.
