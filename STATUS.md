...
Atualizado: 2026-09-10. Projeto: `/Users/douglas/Projects/Umanni`. O repositório é o vault; registros da conversa foram preservados aqui. Use este índice para distinguir estado atual de propostas históricas.
...
Spec Kit 1.0.6 inicializado localmente para Codex. Constituição, README, protocolo, índices e spec/plano/tarefas documentais preparados. Validação e commit registrados em EXEC-000-DOCUMENTACAO.md. Nenhuma aplicação, CI, runner ou branding implementado; remoto não foi alterado nesta entrega.
...
- Antes do primeiro PR: plano e implantação das proteções/checks mínimos, bootstrap da branch remota e controle de achados; definir como assinar comentários por papel/modelo na identidade GitHub usada. Mesmo login não cria revisores independentes na plataforma.
